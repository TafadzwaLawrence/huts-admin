...
export function AdminExportButton({ type, label }: AdminExportButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-1.5 px-3 py-1.5 text-sm border border-adm-border text-adm-muted hover:bg-adm-surface-2 hover:text-adm-text transition-colors disabled:opacity-50"
    >
      <Download size={14} />
